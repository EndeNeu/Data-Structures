...
import com.ebusiello.data.structure.immutable.trees.binaries.GenericBinaryNode
import com.ebusiello.data.structure.immutable.trees.generic.node.{ BalanceableNode, OrderableNode, RetractableNode, RotableNode }
