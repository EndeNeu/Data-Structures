...
//import com.ebusiello.fds.tree.binaryTree.balanced.left.{LeftBalancedEmptyNode, LeftBalancedBinaryTree}
//import com.ebusiello.fds.com.ebusiello.fds.tree.generic.com.ebusiello.fds.tree._
//
///**
...
// *
// * possible com.ebusiello.fds.tree       impossible com.ebusiello.fds.tree
// *    2                      2
// *   / \                    / \
// *  1  3                   3  1
// *
...
// */
//final class BinarySearchTree[T](val head: AbstractBinarySearchNode[T]) extends AbstractBinarySearchTree[T](head) with SortableTree[T, BinarySearchTree] with DeletableTree[T, BinarySearchTree]{
//
//
//  /**
...
//
//  /**
//   * Insert an element of type T in a com.ebusiello.fds.tree, if the com.ebusiello.fds.tree is empty
...
//
//  /**
//   * Map a function over a com.ebusiello.fds.tree, this returns a new com.ebusiello.fds.tree which is not a search com.ebusiello.fds.tree
...
//
//  /**
//   * Sort a search com.ebusiello.fds.tree, note that sorting will always yield a right com.ebusiello.fds.tree id the order is ascending, a lef tif it's descending:
//   *
//   *    2 -- sort -->      1
//   *   / \                / \
//   *  1  3               E  2
...
//  }
//
//  override def delete(mValue: T)(implicit ord: Ordering[T]): BinarySearchTree[T] =
//    new BinarySearchTree[T](head.delete(mValue))
//
//}
//
