...
class QueueLinkedListSpec extends WordSpecLike with Matchers {

  trait TestContext {
    val emptyQueue = new QueueLinkedList[Int]()
    val nonEmpty: QueueLinkedList[Int] = QueueLinkedList[Int](1).append(2).append(5).append(7).append(8)
  }
