...
//
//import com.ebusiello.fds.com.ebusiello.fds.tree.binaryTree.balanced.left.LeftBalancedBinaryTree
//import com.ebusiello.fds.com.ebusiello.fds.tree.binaryTree.search.{BinarySearchNode, BinarySearchTree}
...
//    "delete" in {
//
//      val com.ebusiello.fds.tree = BinarySearchTree.fromColl[Int, List[Int]](List(1, -10, 10, 6, 5, 9, 15, 14, 20))
//
//      val j = com.ebusiello.fds.tree.delete(10)
//
//      com.ebusiello.fds.tree.delete(10).getHead match {
...
//      }
//
//       com.ebusiello.fds.tree.delete(10).find(10) must beEqualTo(false)
//    }
//  }
//}
